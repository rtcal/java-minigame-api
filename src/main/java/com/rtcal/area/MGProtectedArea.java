...
public class MGProtectedArea extends MGArea {
    ...
    public MGProtectedArea(@NotNull String name, @NotNull MGLocation loc1, @NotNull MGLocation loc2, @NotNull MGAreaSettings settings, int priority, @NotNull MGAreaManager areaManager) throws MGDuplicateAreaID {
        super(name, loc1, loc2, priority, areaManager);
        this.settings = settings;
    }

    public MGProtectedArea(@NotNull String name, @NotNull UUID uuid, @NotNull MGLocation loc1, @NotNull MGLocation loc2, @NotNull MGAreaSettings settings, int priority, @NotNull MGAreaManager areaManager) throws MGDuplicateAreaID {
